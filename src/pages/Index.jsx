      ...
      <Section title="About Insight Property Tax" bgColor="bg-gray-100">
        <div className="mb-8 text-left">
          ...
          <p className="text-lg mb-8">
            With experience on both sides of property tax appeals, we offer our clients a straightforward path to cut through the bureaucracy and provide results <span className="font-bold text-[#0A2647]">⇒ <span className="text-xl">reduced property taxes</span></span>.
          </p>
        </div>
