...
const AboutInsightSection = () => (
  <section className="py-16 bg-gradient-to-br from-[#0A2647] to-[#2E5077] text-white relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative z-10">
      <h2 className="text-3xl font-semibold text-center mb-8 text-white">Expert Property Tax Appeals</h2>
      <div className="mb-8">
        <p className="text-lg mb-4">Insight Property Tax specializes in reducing assessment values for commercial, industrial, and apartment property owners and tenants, saving our clients significant amounts on property taxes.</p>
        <p className="text-lg mb-4">Our local expertise in property tax laws gives clients direct access to a proven system that identifies over-assessments and consistently delivers successful appeal settlements.</p>
      </div>
...
const WhoWeWorkWith = () => (
  <section className="py-16 bg-gradient-to-br from-[#0A2647] to-[#2E5077] text-white relative overflow-hidden">
    <div className="absolute inset-0 bg-[url('/hero-pattern.svg')] opacity-10"></div>
    <div className="container mx-auto px-4 relative z-10">
      <h2 className="text-3xl font-semibold text-center mb-8 text-white">Our Property Tax Appeal Services</h2>
      <div className="text-left mb-8">
        <p className="text-lg mb-4">We provide expert property tax appeal services for commercial, industrial, and apartment property owners and tenants across the state.</p>
        ...
        <p className="text-lg mb-4">Insight Property Tax makes it easy to reduce property tax costs and maximize your profits with our straightforward appeal process.</p>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <Helmet>
        ...
        <meta name="description" content="Maximize your savings on commercial, industrial, and apartment property taxes with Insight Property Tax. Expert appeals and proven results for tax reduction." />
        ...
        <section className="bg-gradient-to-br from-[#0A2647] via-[#1E3A5F] to-[#2E5077] text-white py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-2xl">
              ...
              <p className="text-xl mb-8">Maximize your savings on commercial, industrial, and apartment property taxes with our expert appeal services.</p>
              <Link to="/contact">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <StatCard icon={DollarSign} title="Risk-Free Appeals" description="You pay only if we successfully reduce your property taxes." />
              <StatCard icon={CheckCircle} title="Local Expertise" description="Hundreds of settled appeals from professionals with appraisal and assessment backgrounds." />
              <StatCard icon={LineChart} title="Advanced Analytics" description="Data-driven strategies to maximize your property tax savings." />
            </div>
          </div>
        </section>
        <AboutInsightSection />
