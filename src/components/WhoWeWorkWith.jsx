...
const WhoWeWorkWith = () => (
  <section className="py-16 relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative z-10">
      <h2 className="text-4xl md:text-5xl font-semibold text-center mb-12 text-white shadow-text">Property Tax Appeal Services</h2>
      
      <div className="w-full space-y-12">
        <div>
          <h3 className="text-3xl md:text-4xl font-semibold mb-6 text-left text-white shadow-text">Appeal Service Types</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <AppealServiceCard 
              icon={BookOpen}
        ...
        <div>
          <h3 className="text-3xl md:text-4xl font-semibold mb-6 text-left text-white shadow-text">Property Types</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <h3 className="text-3xl md:text-4xl font-semibold mb-6 text-left text-white shadow-text">Minnesota Service Locations</h3>
