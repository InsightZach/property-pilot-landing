  ...
  return (
    <>
      <section className="mb-12">
        <h2 className="text-3xl font-semibold mb-6 text-[#0A2647]">Minnesota Property Tax Cycle</h2>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-semibold mb-6 text-[#0A2647]">Appeal Process Overview</h2>
        <p className="mb-6 text-gray-700">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-semibold mb-6 text-[#0A2647]">Important Resources</h2>
