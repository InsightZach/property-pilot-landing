...
const AboutInsightSection = () => (
  <section className="py-16 bg-white">
    <div className="container mx-auto px-8 md:px-16">
      <h2 className="text-4xl md:text-5xl font-semibold text-center mb-8 text-[#0A2647]">Expert Minnesota Property Tax Appeals</h2>
      <div className="flex flex-col items-center justify-center mb-8">
        <div className="flex flex-col md:flex-row justify-center items-center mb-4">
          <div className="flex items-center mb-2 md:mb-0 md:mr-6">
            <Building2 className="text-[#d7b971] w-8 h-8 mr-2" />
            <span className="text-xl text-[#0A2647]">Commercial</span>
          </div>
          <div className="flex items-center mb-2 md:mb-0 md:mr-6">
            <Factory className="text-[#d7b971] w-8 h-8 mr-2" />
            <span className="text-xl text-[#0A2647]">Industrial</span>
          </div>
          <div className="flex items-center">
            <Home className="text-[#d7b971] w-8 h-8 mr-2" />
            <span className="text-xl text-[#0A2647]">Apartments</span>
          </div>
        </div>
      </div>
...
const StatCard = ({ icon: Icon, title, description, badge }) => (
  <div className="bg-[#324E6E] text-white p-6 rounded-lg relative">
    {badge && (
      <span className="absolute top-2 right-2 bg-[#d7b971] text-[#0A2647] text-sm font-bold py-1 px-2 rounded">
        {badge}
      </span>
    )}
    <Icon className="text-[#d7b971] mb-4 h-14 w-14 mx-auto" />
    <h4 className="text-2xl font-semibold mb-2 text-center">{title}</h4>
